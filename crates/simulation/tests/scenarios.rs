...
use hyperscale_scenarios::{
    ...
    vm_hot_recipient, vm_insolvent_payer_engages_nothing, vm_single_transfer,
    vm_snapshot_only_commits_nothing, vm_snapshot_reads_committed_baseline, vm_zipf_payments,
